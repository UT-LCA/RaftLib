 ...
 * @version: Tue Mar 07 14:00:00 2023
 *
 ...
 */
#ifndef RAFT_ALLOCATE_DATAMANAGER_TCC
#define RAFT_ALLOCATE_DATAMANAGER_TCC  1
#include <cassert>
#include <cstddef>
#include <array>
#include <thread>
...
template < class T, Buffer::Type::value_t B, size_t SIZE = 0 >
class DataManager
{
public:
   DataManager( )         = default;
   ...
   void resize( Buffer::Data< T, B > *new_buffer, volatile bool &exit_buffer )
   {
      ...
      auto buffercondition( []( Buffer::Data< T, B > * const buff_ptr ) noexcept -> bool
      {
          ...
          * file.
          */
         const auto rpt( Buffer::Pointer::val( buff_ptr->read_pt  ) );
    ...
    * will soon be in use.
    * @param - key, Buffer::access_key
    */
   void enterBuffer( const Buffer::access_key key ) noexcept
   {
      /** see lambda below **/
      set_helper( key,
    ...
    * @param - key, Buffer::access_key
    */
   void exitBuffer( const Buffer::access_key key ) noexcept
   {
      /** see lambda below **/
      set_helper( key,
...
}; /** end DataManager decl **/

} /** end namespace raft **/

#endif /* END RAFT_ALLOCATE_DATAMANAGER_TCC */
